...
Good news even, we were able to come up with functioning code for both an ESP32 and a Raspberry Pi Pico. We're working on getting one for the Arduino UNO up soon since that's the most common microcontroller.

We're using a custom URDF for the simulation/visualization accessible also in [docs](./docs)
